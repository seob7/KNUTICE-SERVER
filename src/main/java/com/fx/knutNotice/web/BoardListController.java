...
@Tag(name = "BoardList Controller", description = "PAGINATION API")
public class BoardListController {
    ...
    public ResultForm showGeneralNews(
        @Parameter(description = "마지막 순번, 최초 요청시 값X", in = ParameterIn.QUERY) @RequestParam(required = false) Long startBoardNumber,
